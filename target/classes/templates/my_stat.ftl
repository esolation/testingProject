  ...
  <main class="main-my_stat">
    <div class="title-box">
      ...
      <div class="test-stat-box">
        ...
        <#list marks as mark>
        <div class="test-name-stat">
          <p>
            <a  href="#">
              ${mark.getTopicName()}
            </a>
          </p>
          <div class="mark">${mark.getMark()}</div>
        </div>
        </#list>
        ...
        <button class="trener-stat-btn" type="submit" name="trener">Тренеровка</button>
        <button class="print-stat-btn" type="submit" name="print">Печать</button>
