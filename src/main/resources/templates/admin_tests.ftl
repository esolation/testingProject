...
<#--          <div class="categories "><a href="">Русский язык</a></div>-->
<#--          <div class="categories 2"><a href="">Математика</a></div>-->
...
<#--          <div class="categories him"><a href="">Химия</a></div>-->
          ${questions[0].topic.getTopicName()}
        </div>
        ...
        <div class="test-name-admin">
          ...
          <p>
            ...
            <a  href="/admin/${question.getTopic().getId()}/${question.getId()}">
...
<#--          </div>-->
        ...
        <button class="add-test" type="submit" name="add-test">
          <form action="${questions[0].topic.getTopicName()}" method="post"><input type="hidden" name="_csrf" value="${_csrf.token}"><input type="submit" value="Добавить вопрос"></form></button>
      </div>
