      ...
      <div class="test-stat-box">
        <div class="categories-box">
          <#list subjects as subject>
            <#assign display>
              <#if subject.getSubjectname() == "Математика">display = mat
              <#elseif subject.getSubjectname() == "Русский язык">display = rus
              <#elseif subject.getSubjectname() == "Физика">display = fiz
              <#elseif subject.getSubjectname() == "Биология">display = bio
              <#elseif subject.getSubjectname() == "Химия">display = him</#if>


            </#assign>
            <div class="categories ${display}"><a href="">${subject.getSubjectname()}</a></div>
          </#list>
<#--          <div class="categories all"><a href="">Все</a></div>-->
...
<#--          <div class="categories him"><a href="">Химия</a></div>-->
        ...
        <div class="test-name-admin">
          ...
          <p>
            ...
            <a  href="/admin/${topic.getId()}">
              ${topic.getTopicName()} (${topic.subject.getSubjectname()})
            </a>

          </p>

          <div class="test-admin-edit">
<#--            <button class="test-admin-veiw" type="submit" name="view"><i class="fa fa-eye"></i></button>-->
...
<#--            <button class="test-admin-del" type="submit" name="del"><i class="fa fa-trash"></i></button>-->
        ...
        <button class="add-test" type="submit" name="add-test"><a href="/createquestion">Добавить тест</a></button>
      </div>
